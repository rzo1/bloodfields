...
java -jar target/bloodfield-0.1.0-SNAPSHOT-all.jar
```

Java 21 required. The shade plugin produces `bloodfield-0.1.0-SNAPSHOT-all.jar`
...
- App version is set via the `jpackage.appVersion` Maven property
  ...
  which is why this is independent of the project's `0.1.0-SNAPSHOT` version.
