...
class RendererPaletteTest {
    ...
    void factionFillsAreDarker() {
        ...
        Color red = assets.factionFill(com.github.rzo1.bloodfields.model.Faction.RED);
        Color blue = assets.factionFill(com.github.rzo1.bloodfields.model.Faction.BLUE);
