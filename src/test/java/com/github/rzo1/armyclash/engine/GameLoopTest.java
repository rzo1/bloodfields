...
class GameLoopTest {
    ...
    void riverTerrainStopsUnitMovement() {
        com.github.rzo1.armyclash.model.Terrain.TileType[][] tiles = new com.github.rzo1.armyclash.model.Terrain.TileType[10][10];
        for (int cx = 0; cx < 10; cx++) {
            for (int cy = 0; cy < 10; cy++) {
                tiles[cx][cy] = com.github.rzo1.armyclash.model.Terrain.TileType.RIVER;
            }
        }
