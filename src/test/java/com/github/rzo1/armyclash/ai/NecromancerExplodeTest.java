...
class NecromancerExplodeTest {
    ...
    void corpseExplosionDamagesFriendsAndFoesInRadius() {
        ...
        assertTrue(friend1.hp < f1Hp || friend1.state == com.github.rzo1.armyclash.model.UnitState.DEAD,
                "friend1 should take damage or die");
        assertTrue(friend2.hp < f2Hp || friend2.state == com.github.rzo1.armyclash.model.UnitState.DEAD,
                "friend2 should take damage or die");
        assertTrue(foe1.hp < e1Hp || foe1.state == com.github.rzo1.armyclash.model.UnitState.DEAD,
                "foe1 should take damage or die");
        assertTrue(foe2.hp < e2Hp || foe2.state == com.github.rzo1.armyclash.model.UnitState.DEAD,
