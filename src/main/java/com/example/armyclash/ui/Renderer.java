...
public final class Renderer {
    ...
    private static final double BOULDER_R = 5.0;
    private static final Color BOULDER_FILL = Color.web("#5a4d3a");
    private static final Color BOULDER_STROKE = Color.web("#2a2520");
    private static final Color BOULDER_TRAIL = Color.web("#7a6a55");
