...
public enum UnitType {
    INFANTRY("Infantry", 50.0, 10.0, 18.0, 40.0, 1.0, false, 10, 0.0, true, 0.0, false, false,
            "Tough melee line. Counters archers."),
    ARCHER("Archer", 30.0, 8.0, 180.0, 35.0, 1.5, true, 15, 0.0, true, 0.0, false, false,
            "Long-range. Strong vs cavalry."),
    CAVALRY("Cavalry", 80.0, 15.0, 20.0, 80.0, 1.2, false, 25, 0.0, true, 0.0, false, false,
            "Fast charger. Crushes infantry, dies to archers."),
    MAGE("Mage", 35.0, 18.0, 140.0, 30.0, 2.0, true, 30, 50.0, true, 0.0, false, false,
            "Ranged AoE splash. Slow and fragile."),
    DRAGON("Dragon", 600.0, 40.0, 110.0, 55.0, 1.4, true, 999, 45.0, false, 0.0, false, false,
            "Boss. Massive HP and fire breath. (Enemy/opt-in only.)"),
    NECROMANCER("Necromancer", 60.0, 8.0, 130.0, 30.0, 3.0, true, 50, 0.0, true, 80.0, false, false,
            "Revives a corpse for your side or detonates it (friendly fire)."),
    HEALER("Healer", 40.0, 0.0, 80.0, 35.0, 1.5, true, 35, 0.0, true, 80.0, false, false,
            "Heals nearby allies. No direct damage."),
    CATAPULT("Catapult", 120.0, 35.0, 240.0, 15.0, 4.0, true, 60, 70.0, true, 0.0, false, false,
            "Slow siege engine. Massive AoE."),
    ASSASSIN("Assassin", 25.0, 22.0, 18.0, 110.0, 0.6, false, 30, 0.0, true, 0.0, true, false,
            "Fast melee. High damage, low HP. Ignores armor."),
    GOLEM("Golem", 300.0, 20.0, 22.0, 20.0, 2.0, false, 80, 0.0, true, 0.0, false, false,
            "Slow walking tank. Devastating in melee."),
    PIKEMAN("Pikeman", 55.0, 11.0, 25.0, 38.0, 1.0, false, 15, 0.0, true, 0.0, false, false,
            "Anti-cavalry spearman."),
    GENERAL("General", 180.0, 18.0, 22.0, 45.0, 1.5, false, 100, 0.0, true, 120.0, false, true,
    ...
    UnitType(String displayName, double maxHp, double damage, double attackRange,
             ...
             boolean armorPiercing, boolean unique, String description) {
