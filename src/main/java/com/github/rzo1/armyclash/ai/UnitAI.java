...
import com.github.rzo1.armyclash.engine.Corpse;
import com.github.rzo1.armyclash.engine.CorpseField;
import com.github.rzo1.armyclash.engine.GameState;
import com.github.rzo1.armyclash.engine.StructureHelper;
import com.github.rzo1.armyclash.engine.UnitUpdater;
...
public final class UnitAI implements UnitUpdater {
    ...
    static boolean lineCrossesImpassable(World w,
                                         com.github.rzo1.armyclash.engine.StructureField structures,
    ...
    private static void spawnProjectile(Unit u, GameState state) {
        ...
        if (u.garrisoned && state.structures != null) {
            com.github.rzo1.armyclash.engine.Structure host =
