...
import com.github.rzo1.armyclash.ui.AssetLoader;
import com.github.rzo1.armyclash.ui.BattleSmoke;
import com.github.rzo1.armyclash.ui.BloodyTiles;
import com.github.rzo1.armyclash.ui.Hud;
import com.github.rzo1.armyclash.ui.Camera;
import com.github.rzo1.armyclash.ui.CameraShake;
import com.github.rzo1.armyclash.ui.CrowFlock;
import com.github.rzo1.armyclash.ui.DeathTracker;
import com.github.rzo1.armyclash.ui.DeploymentOverlayRenderer;
import com.github.rzo1.armyclash.ui.DeploymentZone;
import com.github.rzo1.armyclash.ui.LimbField;
import com.github.rzo1.armyclash.ui.MainMenuRenderer;
import com.github.rzo1.armyclash.ui.MapStructures;
import com.github.rzo1.armyclash.ui.ParticleSystem;
import com.github.rzo1.armyclash.ui.RagdollOverlay;
import com.github.rzo1.armyclash.ui.Renderer;
import com.github.rzo1.armyclash.ui.ScorchMarks;
import com.github.rzo1.armyclash.ui.StuckArrows;
import com.github.rzo1.armyclash.ui.Theme;
import com.github.rzo1.armyclash.ui.Vulture;
...
public final class ScreenshotGenerator {
    ...
    private static void renderFortress(Path outDir) throws IOException {
        ...
        for (Structure s : state.structures.structures()) {
            if (s.type() == com.github.rzo1.armyclash.engine.StructureType.TOWER) {
                int cap = com.github.rzo1.armyclash.engine.StructureField.garrisonCapacity(s.type());
                int placed = 0;
